...
@torch.no_grad()
def sample_sa_solver_pece_renoise(model, x, sigmas, vae=None, extra_args=None, callback=None, disable=False, predictor_order=3, corrector_order=4, pc_mode="PECE", tau_func=None, noise_sampler=None, smea=False, dyn=False, invert=False, normalize=False, gamma=1.0, scale=1.0, shift=0, renoise=False, renoise_alternative=False, renoise_scale=1.0, renoise_seed=1.0):
    if BACKEND == "WebUI":
        from modules import shared
        renoise_scale = shared.opts.renoise_scale
        renoise_seed = shared.opts.renoise_seed
...
@torch.no_grad()
def sample_sa_solver_pece_renoise_dy(model, x, sigmas, vae=None, extra_args=None, callback=None, disable=False, predictor_order=3, corrector_order=4, pc_mode="PECE", tau_func=None, noise_sampler=None, smea=False, dyn=False, invert=False, normalize=False, gamma=1.0, scale=1.0, shift=0, renoise=False, renoise_alternative=False, renoise_scale=1.0, renoise_seed=1.0):
    if BACKEND == "WebUI":
        from modules import shared
        renoise_scale = shared.opts.renoise_scale
        renoise_seed = shared.opts.renoise_seed
